...
test.describe('Collaborator Management', () => {
  test.describe('Feature: Collaborator Management', () => {
    ...
    test('Scenario: Edit a collaborator - UI elements exist', async ({ page }) => {
      await page.goto('/dashboard')
    ...
    test('Scenario: Archive a collaborator - UI elements exist', async ({ page }) => {
      await page.goto('/dashboard')
    ...
    test('Scenario: Delete a collaborator - UI elements exist', async ({ page }) => {
      await page.goto('/dashboard')
